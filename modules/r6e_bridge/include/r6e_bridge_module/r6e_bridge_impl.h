...
class R6eBridgeImpl final : public Device
{
public:
    explicit R6eBridgeImpl(const std::shared_ptr<MiniaudioContext>& maContext, const ma_device_id& id, const ContextPtr& ctx, const ComponentPtr& parent, const StringPtr& localId);
    ~R6eBridgeImpl() override;
